package Perl::Critic::Policy::Periscope::ProhibitDollarOpenBracket;
...
Readonly::Scalar my $EXPL => q{$[ has been depreacated.                                         };
...
Perl::Critic::Policy::Periscope::ProhibitDollarOpenBracket - Prohibit the use of the deprecated $[ variable
